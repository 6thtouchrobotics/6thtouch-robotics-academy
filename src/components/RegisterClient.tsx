          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-16 items-center">
            <div className="lg:col-span-7 text-left text-black">
              ...
              <p className="text-sm mb-4 leading-relaxed flex flex-wrap items-center gap-x-2 gap-y-1 text-gray-800">
                ...
                <span></span>
                <FaLocationDot className="inline align-middle" /> <strong>Nonpariels Montessori School, 54, Tola Ogunmade Street Tedi, Opposite Ojo Barracks, Ojo, Lagos, Nigeria</strong>
              </p>
