    ...
    <section className="w-full py-16 mt-20 mb-12 font-sans text-left">
      <div className="max-w-[800px] mx-auto px-6">
        <h1 className="text-3xl font-bold mb-2 text-[#FF6A00] leading-tight">
          Application for Teachers Tutoring
        </h1>
        <p className="text-base text-gray-500">Please complete this form to request a tutor as a teacher.</p>
        
        <form
          className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8"
          action="https://formspree.io/f/mrbzkkzo"
          method="post"
        >
          <FormInput
            label="First name"
          ...
          <FormSelect
            label="Number of teachers to be tutored"
