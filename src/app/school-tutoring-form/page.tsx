  ...
  return (
    <section className="container-fluid py-5 mt-5 mb-5">
      <div className="container py-4">
        <h1 className="h2 fw-bold mb-2" style={{ color: "#FF6A00" }}>Application for School Tutoring</h1>
        <p className="lead">Please complete this form to request a tutor for your school.</p>
        <form
          className="row mt-4"
        ...
        >
          ...
          <div className="col-md-6 mt-3">
            <select
              ...
              required
            >
              <option value="">Number of students to be tutored *</option>
